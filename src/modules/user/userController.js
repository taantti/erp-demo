...
export const readUserReport =  (req, res) => {
    log("INFO", "userReportService.readUserReport(): ", true, req);
};

export const readUsers = async (req, res) => {
    log("INFO", "userService.readUsers(): ", true, req);
...
export const createUser = async (req, res) => {
    log("INFO", "userService.createUser(): ", true, req);
...
export const updateUser = async (req, res) => {
    log("INFO", "userService.updateUser(): ", true, req);
...
export const deleteUser = async (req, res) => {
    log("INFO", "userService.deleteUser(): ", true, req);
